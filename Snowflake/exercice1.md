...
Ce premier lab vous présente l'interface utilisateur et les fonctionnalités de base de Snowflake. Il est spécialement conçu pour être utilisé avec Snowflake, essai gratuit https://github.com/atifrani/Modern-Data-Architecture/blob/main/Snowflake/exercice1.md de 120 jours sur https://signup.snowflake.com/?trial=student&cloud=aws&region=us-west-2&utm_source=handsonessentials&utm_campaign=uni-dww#. Une fois le laboratoire terminé, vous devriez être prêt à charger vos propres données dans Snowflake et à découvrir ses fonctionnalités plus avancées.
...
Si ce n'est pas encore fait, inscrivez-vous pour un essai gratuit de Snowflake de 120 jours sur https://signup.snowflake.com/?trial=student&cloud=aws&region=us-west-2&utm_source=handsonessentials&utm_campaign=uni-dww#
...
* Les fournisseurs de cloud **AWS**, pour ce lab choisissez et la région **us-west-2**.     
